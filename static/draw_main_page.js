...
d3_make_bipartite_graph("/data/example1.tsv", {container_id: "example_1"});
d3_make_bipartite_graph("/data/example2.tsv", {container_id: "example_2"});
...
d3_make_bipartite_graph("/data/english_vowels_shortened_sorted.tsv", {container_id: "english_vowels", translations: false});
